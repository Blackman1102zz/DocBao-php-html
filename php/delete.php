            ...
            <div class = "news_main">
                <div class = "news_top">
                    ...
                    <form class="form" action="delete_exec.php" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="end"></div>
                        <label>Tiêu đề</label><?php echo $result["title"]?>
                        <div class="end"></div>
                        <label>Code</label><?php echo $result["code"]?>
                        <div class="end"></div>
                        <label>Mô tả</label><?php echo $result["description"]?>
                        <div class="end"></div>
                        <label>Thân bài</label><?php echo $result["body"]?>
                        <div class="end"></div>
                        <label>Trạng thái</label><?php echo $result["status"]?>
                        <div class="end"></div>
