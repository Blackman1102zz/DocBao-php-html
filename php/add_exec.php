...
<body>
    ...
    <div class ="wrapper">
        ...
        <div class="news_2col">
            <div class = "news_main">
                <div class = "news_top">
                    <h1>Kết quả thêm bài tin</h1>
                    <br clear="all">
                    Bạn đã thêm dữ liệu bài viết thành công, bạn muốn thực hiện <a href="add.php">thêm mới</a> hay quay về <a href="search.php">danh sách bài viết.</a>
                    <br clear="all">
                    <br clear="all">
                </div>
            </div>
