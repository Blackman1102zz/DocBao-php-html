            ...
            <div class = "news_main">
                <div class = "news_top">
                    ...
                    <form class="form" action="add_exec.php" method="post"  enctype="multipart/form-data">
                        ...
                        <br clear ="all">
                        <label>Ảnh</label><input type="file" name="img" value=""/>
                        <br clear ="all">
                        <label>Tiêu đề</label><input name="title" value=""/>
                        <br clear ="all">
                        <label>Code</label><input name="code" value=""/>
                        <br clear ="all">
                        <label>Mô tả</label><input name="description" value=""/>
                        <br clear ="all">
                        <label>Thân bài</label><textarea name="body"></textarea>
                        <br clear ="all">
